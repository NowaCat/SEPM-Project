...
//        Assert.assertEquals(driver.getCurrentUrl(), "http://localhost:3000/dashboard");
        driver.get("http://localhost:3000/addTour");
        driver.findElement(By.name("tourName")).sendKeys("test tour 1");
        driver.findElement(By.name("tourIdentifier")).sendKeys("TEST1");
        driver.findElement(By.id("submitTour")).click();
        driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
        Assert.assertEquals(driver.getCurrentUrl(), "http://localhost:3000/addTour");
    }
